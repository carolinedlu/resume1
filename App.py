...
def show_pdf(file_path):
    ...
    pdf_display = f'<iframe src="https://drive.google.com/viewerng/viewer?embedded=true&url=data:application/pdf;base64,{base64_pdf}" width="700" height="1000" type="application/pdf"></iframe>'
