...
def show_pdf(file_path):
    ...
    pdf_display = F'<iframe src="https://docs.google.com/viewerng/viewer?url=data:application/pdf;base64,{base64_pdf}&embedded=true" width="700" height="1000" type="application/pdf"></iframe>'
